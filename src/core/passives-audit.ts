...
export const CAMPAIGN_PASSIVE_QUESTS: PassiveQuestDefinition[] = [
  ...
  { id: 'a7-million-faces', name: 'The Master of a Million Faces', act: 7, points: 1, recovery: 'Defeat Greust in The Ashen Fields, then claim the quest reward in The Bridge Encampment.' },
  ...
  { id: 'a8-love-dead', name: 'Love is Dead', act: 8, points: 1, recovery: 'Complete Clarissa’s Tolman objective through The Quay and The Grain Gate sequence, then return for the Book of Skill.' },
  ...
  { id: 'a9-highgate', name: 'The Ruler of Highgate', act: 9, points: 1, recovery: 'Defeat Kira and Garukhan in The Quarry/The Refinery objective chain, then return to Highgate for the Book of Skill.' },
