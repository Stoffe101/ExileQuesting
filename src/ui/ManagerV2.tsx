...
function Overview({ state, setState, onNavigate, onOpenPassive }: { state: RuntimeState; setState: (state: RuntimeState) => void; onNavigate: (tab: AppTab) => void; onOpenPassive: () => void }) {
